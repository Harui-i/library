...
data:
  ...
  bundledCode: "#line 1 \"test/verify/yosupo-inv-of-formal-power-series-fast1-test.cpp\"\
    ...
    \ =  ((*this).rev().pre(sz) * rhs.rev().inv_fast2(sz)).pre(sz).rev();\n  }\n\n\
    \  FPS& operator%=(const FPS &rhs) {\n    *this -= *this / rhs * rhs;\n    shrink();\
    ...
    \ FPS operator/(FPS a, const mint& b) {return a /= b; }\n  \n  // sz\u6B21\u672A\
    ...
    \ 0; i < fps.size(); ++i) {\n      if (i > 0) os << \" \";\n      os << fps._vec[i].val();\n\
    \    }\n    return os;\n  }\n};\n#line 6 \"test/verify/yosupo-inv-of-formal-power-series-fast1-test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2024-06-12 14:42:30+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: test/verify/yosupo-inv-of-formal-power-series-fast1-test.cpp
layout: document
redirect_from:
- /library/test/verify/yosupo-inv-of-formal-power-series-fast1-test.cpp
- /library/test/verify/yosupo-inv-of-formal-power-series-fast1-test.cpp.html
