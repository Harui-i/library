...
data:
  ...
  bundledCode: "#line 1 \"test/verify/fps/yosupo-pow-of-formal-power-series.test.cpp\"\
    ...
    \n\n#line 5 \"test/verify/fps/yosupo-pow-of-formal-power-series.test.cpp\"\nusing\
    ...
    \ long sqrt_coeff = mod_sqrt(_vec[lowest_deg].val(), mint::mod());\n    if (sqrt_coeff\
    \ == -1) return FPS(0);\n\n    int rest_deg = deg - shift;\n    FPS f = ((*this\
    \ >> lowest_deg) / _vec[lowest_deg]).pre(rest_deg);\n    FPS g = {mint(1)};\n\
    ...
    [3d, 4d)\n\n  g = g_origin - h_2d;\n  g.resize(d * 2);\n}\n\n\n#line 8 \"test/verify/fps/yosupo-pow-of-formal-power-series.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/verify/fps/yosupo-pow-of-formal-power-series.test.cpp
layout: document
redirect_from:
- /verify/test/verify/fps/yosupo-pow-of-formal-power-series.test.cpp
- /verify/test/verify/fps/yosupo-pow-of-formal-power-series.test.cpp.html
