...
data:
  ...
  bundledCode: "#line 1 \"test/verify/math/yosupo-multiplication-of-big-integers.test.cpp\"\
    ...
    \ v) {\n    return os << v.to_string();\n  }\n};\n\n\n#line 5 \"test/verify/math/yosupo-multiplication-of-big-integers.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/verify/math/yosupo-multiplication-of-big-integers.test.cpp
layout: document
redirect_from:
- /verify/test/verify/math/yosupo-multiplication-of-big-integers.test.cpp
- /verify/test/verify/math/yosupo-multiplication-of-big-integers.test.cpp.html
