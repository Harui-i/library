...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/home/runner/work/library/library/.venv/lib/python3.12/site-packages/onlinejudge_verify/documentation/build.py\"\
    , line 71, in _render_source_code_stat\n    bundled_code = language.bundle(stat.path,\
    \ basedir=basedir, options={'include_paths': [basedir]}).decode()\n          \
    \         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n\
    \  File \"/home/runner/work/library/library/.venv/lib/python3.12/site-packages/onlinejudge_verify/languages/python.py\"\
